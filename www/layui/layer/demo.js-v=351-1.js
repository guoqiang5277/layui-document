  ...
  if(!notLayuiAdmin && false){
    layer.open({
      ...
      ,content: ['<div style="padding: 15px; text-align: center; background-color: #e2e2e2;">'
        ,'<a href="https://www.baidu.com/" target="_blank"><img src="../../cdn.layui.com/upload/2018_5/168_1527691799254_76462.jpg"/*tpa=http://cdn.layui.com/upload/2018_5/168_1527691799254_76462.jpg*/ alt="layuiAdmin" style="width: 100%; height:149.78px;"></a>'
      ,'</div>'].join('')
      ,success: function(layero, index){
        var btn = layero.find('.layui-layer-btn');
        btn.find('.layui-layer-btn0').attr({
